...
| 4a | `cd frontend && npm test` | Frontend unit tests via vitest (ThemeContext, etc.) |
| 4b | `cd frontend && npm run build` | TypeScript compilation — catches type errors before CI |
