...
export const MOCK_RECIPES: RecipeDto[] = [
  {
    ...
    ingredients: [
      { ingredientId: 1, ingredientName: "ground beef", quantity: "500g", sortOrder: 0 },
      { ingredientId: 2, ingredientName: "spaghetti", quantity: "400g", sortOrder: 1 },
      { ingredientId: 3, ingredientName: "onion", quantity: "1 large", sortOrder: 2 },
      { ingredientId: 4, ingredientName: "garlic", quantity: "3 cloves", sortOrder: 3 },
      { ingredientId: 5, ingredientName: "crushed tomatoes", quantity: "400g tin", sortOrder: 4 },
      { ingredientId: 6, ingredientName: "tomato paste", quantity: "2 tbsp", sortOrder: 5 },
      { ingredientId: 7, ingredientName: "parmesan", quantity: "to taste", sortOrder: 6 },
    ],
  },
  {
    id: 2,
    ...
    ingredients: [
      { ingredientId: 8, ingredientName: "whole chicken", quantity: "1.5kg", sortOrder: 0 },
      { ingredientId: 9, ingredientName: "lemon", quantity: "2", sortOrder: 1 },
      { ingredientId: 4, ingredientName: "garlic", quantity: "6 cloves", sortOrder: 2 },
      { ingredientId: 10, ingredientName: "butter", quantity: "50g", sortOrder: 3 },
      { ingredientId: 11, ingredientName: "salt", quantity: "to taste", sortOrder: 4 },
      { ingredientId: 12, ingredientName: "black pepper", quantity: "to taste", sortOrder: 5 },
    ],
  },
  {
    id: 3,
    ...
    ingredients: [
      { ingredientId: 13, ingredientName: "sourdough bread", quantity: "2 slices", sortOrder: 0 },
      { ingredientId: 14, ingredientName: "avocado", quantity: "1 ripe", sortOrder: 1 },
      { ingredientId: 15, ingredientName: "egg", quantity: "2", sortOrder: 2 },
      { ingredientId: 9, ingredientName: "lemon", quantity: "½", sortOrder: 3 },
      { ingredientId: 16, ingredientName: "chili flakes", quantity: "pinch", sortOrder: 4 },
      { ingredientId: 11, ingredientName: "salt", quantity: "to taste", sortOrder: 5 },
    ],
  },
  {
    id: 4,
    ...
    ingredients: [
      { ingredientId: 17, ingredientName: "broccoli", quantity: "1 head", sortOrder: 0 },
      { ingredientId: 18, ingredientName: "carrot", quantity: "2", sortOrder: 1 },
      { ingredientId: 19, ingredientName: "capsicum", quantity: "1", sortOrder: 2 },
      { ingredientId: 20, ingredientName: "snow peas", quantity: "100g", sortOrder: 3 },
      { ingredientId: 4, ingredientName: "garlic", quantity: "2 cloves", sortOrder: 4 },
      { ingredientId: 21, ingredientName: "ginger", quantity: "1 tsp", sortOrder: 5 },
      { ingredientId: 22, ingredientName: "soy sauce", quantity: "2 tbsp", sortOrder: 6 },
      { ingredientId: 23, ingredientName: "oyster sauce", quantity: "1 tbsp", sortOrder: 7 },
      { ingredientId: 24, ingredientName: "sesame oil", quantity: "1 tsp", sortOrder: 8 },
    ],
  },
  {
    id: 5,
    ...
    ingredients: [
      { ingredientId: 25, ingredientName: "banana", quantity: "2 ripe", sortOrder: 0 },
      { ingredientId: 15, ingredientName: "egg", quantity: "2", sortOrder: 1 },
      { ingredientId: 26, ingredientName: "flour", quantity: "½ cup", sortOrder: 2 },
      { ingredientId: 27, ingredientName: "baking powder", quantity: "1 tsp", sortOrder: 3 },
      { ingredientId: 10, ingredientName: "butter", quantity: "1 tbsp", sortOrder: 4 },
      { ingredientId: 11, ingredientName: "salt", quantity: "pinch", sortOrder: 5 },
      { ingredientId: 28, ingredientName: "maple syrup", quantity: "to serve", sortOrder: 6 },
    ],
  },
];
